            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-9  contenidoPlato esp">
                      <div class="col-md-12"><h5 class="text-center">REPORTE DE CREDITOS</h5></div>
                      <div class="col-md-12">
                          <div class="row">
                          <input type="text" class="form-control col-md-4" id="caja_busqueda" placeholder="BUSCAR CREDITO POR NOMBRE" name="caja_busqueda">
