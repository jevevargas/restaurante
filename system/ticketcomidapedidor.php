...
<br>
       ...
       // echo $orden;
        ...
        $pedido = $pdo->prepare("SELECT SUM(cantidadorden) AS cantidades, nomorden,idventa, precioventa , impresionplato, impresion,acocina
        FROM venta LEFT JOIN plato ON venta.idplato=plato.idplato WHERE
          ...
          AND impresionplato='1' AND impresion='1' AND acocina='1' GROUP BY plato.idplato ");
