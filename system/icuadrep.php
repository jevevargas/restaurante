...
$consulta = "insert into cuadre(idusuario,efectivo,tarjeta,credito,cortesia,deposito,egreso,arqueo,fechacierre,fechacierre2,tipocuadre,efecre,planilla,tarcre,bitcre,trancre,fondoinicial) 
values
(:idu,:efe,:tar,:cre,:cor,:dep,:egre,:arqueo,:fechacorta,:fechalarga,:tipo,:creefe,:credes,:cretar,:crebit,:cretran,:inicio)";
