...
<br>
        ...
        AND orden='$orden' AND estadoorden='1' AND impresion='1'  GROUP BY plato.idplato ");
        $pedido->execute();
...
<br><br>  
    ...
    <p class="centrado">TOTAL A PAGAR: $<?php  echo number_format((float) $apagar,2,'.',''); ?>  </p>   
        =============================  
        <center><p>PRECUENTA DE ENVIO</p></center>     
    <center><p>COMPROBANTE DE PRECUENTA *REIMPRESION</p></center>
