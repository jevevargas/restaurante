...
<body>
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="container-fluid">
      ...
      <div class="col-md-12">
        <?php
        $idmesa = $_GET['idmesa']; //echo $idmesa;
        ...
        $idmesa = $_GET['idmesa']; //echo $idmesa;
        date_default_timezone_set('America/El_Salvador');
        $estado = $pdo->prepare(" SELECT * FROM mesa LEFT JOIN orden ON mesa.idmesa=orden.idmesa WHERE orden.idmesa='$idmesa' AND estadoorden = '1' ");
        $estado->execute();
        while ($result = $estado->fetch()) {
          $orden = $result->orden;
          // echo $orden;
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="col-md-12 mesaDetalle">
              <h5>MESA: #<?php echo $nombremesa;  ?> <i class="bi bi-circle-fill activo"></i></h5>
            </div>

            <input type="text" value="<?php echo $idmesa;  ?>" style="display:none" id="idmesa">
            <!-- <input type="text" value="<?php echo $orden;  ?>" style="" id="orden"> -->
            <div class="col-md-12 formCliente" id="formCliente">

            </div>

            <div class="col-md-12 DetalleVenta" id="DetalleVenta">
          ...
          <div class="col-md-8">
            ...
            <div class="co-md-12 contenidoPlato" id="contenidoPlato"> </div>
