...
////////////// Actualizar la tabla /////////
$consulta6 = "insert into pago(totalpago,orden,fechapago,fechapago2,idusuario,tipopago,idcliente) 
values
(:totalpago,:ordenmixto,:fechacorta,:fechalarga,:idu,:tipopago,:cliente)";
...
$sql7->bindParam(':totalpago',$totalpago,PDO::PARAM_STR);
$sql7->bindParam(':ordenmixto',$ordenmixto,PDO::PARAM_INT);
$sql7->bindParam(':fechacorta',$fechacorta,PDO::PARAM_STR);
$sql7->bindParam(':fechalarga',$fechalarga,PDO::PARAM_STR);
$sql7->bindParam(':idu',$idu,PDO::PARAM_INT);
$sql7->bindParam(':tipopago',$tipopago,PDO::PARAM_INT);
$sql7->bindParam(':cliente',$cliente,PDO::PARAM_INT);
