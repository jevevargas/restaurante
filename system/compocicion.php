          ...
          <div id="content" class="container-fluid">
            ...
            <div class="col-md-12">
              <div class="container blanco">
                 <div class="col-md-12"><h5 class="text-center">PLATOS CON INGREDIENTES</h5></div>
                 <hr>
                 <div class="col-md-12">
                 <div class="row">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-7">
                         <a href="platosInactivos" class="btn btn-danger">INACTIVOS</a>
                    </div>

                   <hr>
                    <div class="col-md-12 table-responsive tablaco" id="tablac">
                    </div>
                 </div>
              </div> 
            </div> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <h5 class="text-center">DESACTIVAR ELPLATO?</h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">CANCELAR</button>
        <button type="button" class="btn btn-success" onclick="desactivar()">DESACTIVAR</button>
      </div>
    </div>
