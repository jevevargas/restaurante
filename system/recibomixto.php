<!DOCTYPE html>
 ...
 while ($resul = $estado->fetch()) {  
   ...
   $direccion= $resul ->direccioncliente;
   $dui= $resul ->dui;
 }
?>
 <div class="fecha"><?php echo $dia=date('d-m-Y');  ?></div>
 <div class="nom"><?php echo $cliente;  ?></div>
 <div class="nom"><?php echo $direccion;  ?></div>
 <div class="nom"><?php echo $dui;  ?></div>
 <input type="text" value="<?php echo $orden; ?>" id="imppago" style="display:none">
<div class="taba">
        <table class="espacio">
         <tbody>
...
<?php
 $sumatoria2=0;
  ...
  AND orden='$orden' AND estadoorden='0' AND impresion='1' AND checkfact='1' AND addfactura='0'  GROUP BY plato.idplato ");
  $pedido->execute();
