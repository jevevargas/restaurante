            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-4 contenidoPlato esp">
                   <div class="col-md-12"><h5 class="text-center">INFORMACION DE LA CAJA</h5></div>
                   <hr>
                   <div class="col-md-12">
                    <?php
...
// creditos
                    ...
                    <?php
                     if($admin ==1){
                      ...
                      <div class="col-md-12">
                       ...
                       <div class="col-md-12 alert alert-info"><h5 class="text-center">$<?php $totalventa=$ventas-$tarjeta-$credito-$cortesia-$deposito;
                       echo number_format((float) $totalventa,2,'.','');
                       ?></h5></div>
                       <div class="col-md-12">
                         <div class="row">
                           <button class="btn btn-dark" data-toggle="modal" data-target="#cierre"><i class="bi bi-archive-fill" style="font-size:20px;"></i><br> CERRAR CAJA</button>

                           <button class="btn btn-danger esp"  data-toggle="modal" data-target="#cierrep"><i class="bi bi-archive-fill" style="font-size:20px;"></i><br> CORTE PARCIAL</button>
                      ...
                      ?>
                      <div class="col-md-12"><h5 class="text-center">NO TIENES PERMISO DE ADMINISTRADOR</h5></div>
                      <div class="col-md-12">
                         <div class="row">
                           <button class="btn btn-dark" data-toggle="modal" data-target="#cierre"><i class="bi bi-archive-fill" style="font-size:20px;"></i><br> CERRAR CAJA</button>
                 ...
                 <div class="col-md-7 contenidoPlato esp">
                    <div class="row">
                      ...
                      <div class="col-md-12"><center><button class="btn btn-success" onclick="egreso()">REGISTRAR</button></center></div>
